...
# Add a title       
win.title("Weather Statistics using OpenWeather")
...
open_city_combo['values'] = ( 'Nuzvid, IN','Los Angeles, US', 'London, UK', 'Paris, FR','Beijing, CN')
...
def get_open_weather_data(city='Nuzvid, IN'):
